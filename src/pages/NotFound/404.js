...
import './404.css'
import sadImo from './images/notfouldSadImogi.png'
const NotFound = () => {
    return (

        <div class="flex justify-center items-center h-screen text-center bg-slate-50">
            <div className='space-y-4'>
                <img className='text-slate-400 w-32 md:w-32 lg:w-48' style={{ display: 'block', marginLeft: 'auto', marginRight: 'auto' }} src={sadImo} alt='sad Imogi' />
